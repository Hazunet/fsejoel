...
def handle_input(p, vel, is_jumping, invincibility, is_rolling):
...
def play_level():
    ...
    while True:
        ...
        is_jumping, is_rolling = handle_input(p, vel, is_jumping, invincibility, is_rolling)
